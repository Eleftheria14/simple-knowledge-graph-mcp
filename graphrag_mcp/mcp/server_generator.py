...
# Core components
from ..core import DocumentProcessor, ChatEngine, AdvancedAnalyzer, OllamaEngine
...
class UniversalMCPServer:
    ...
    def _register_core_tools(self):
        ...
        @self.server.tool
        async def search_documents(query: str, collection_name: Optional[str] = None, ctx: Context = None) -> Dict[str, Any]:
    ...
    async def _execute_template_tool(self, tool_name: str, params: Dict[str, Any], ctx: Optional[Context]) -> Dict[str, Any]:
    ...
    async def _query_papers(self, query: str, ctx: Optional[Context]) -> Dict[str, Any]:
        """Academic tool: Query papers in corpus"""
        return await self.search_documents(query, ctx=ctx)
    
    async def _find_citations(self, claim: str, ctx: Optional[Context]) -> Dict[str, Any]:
    ...
    async def _research_gaps(self, domain: str, ctx: Optional[Context]) -> Dict[str, Any]:
    ...
    async def _methodology_overview(self, topic: str, ctx: Optional[Context]) -> Dict[str, Any]:
    ...
    async def _author_analysis(self, author: str, ctx: Optional[Context]) -> Dict[str, Any]:
    ...
    async def _concept_evolution(self, concept: str, ctx: Optional[Context]) -> Dict[str, Any]:
    ...
    async def _generate_bibliography(self, style: str, ctx: Optional[Context]) -> Dict[str, Any]:
