...
# Graphiti components
from ..core.graphiti_engine import (
    GraphitiKnowledgeGraph,
    create_graphiti_knowledge_graph,
)
...
class GraphitiMCPServer:
    ...
    def __init__(self,
        ...
        self.knowledge_graph: GraphitiKnowledgeGraph | None = None
        ...
        async def add_document_to_graph(ctx: Context,
            ...
            try:
                ...
                if success:
                    ...
                    return {"error": "Failed to add document to knowledge graph"}
